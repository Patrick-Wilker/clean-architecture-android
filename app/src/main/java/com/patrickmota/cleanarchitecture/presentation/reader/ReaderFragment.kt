...
import com.patrickmota.cleanarchitecture.presentation.IntentUtil
import com.patrickmota.cleanarchitecture.presentation.library.LibraryFragment
...
class ReaderFragment : Fragment() {
  ...
  companion object {
    ...
    fun newInstance(document: com.patrickmota.core.domain.Document) = ReaderFragment().apply {
  ...
  override fun onActivityCreated(savedInstanceState: Bundle?) {
    ...
    viewModel = ViewModelProvider(this, MajesticViewModelFactory)[ReaderViewModel::class.java]

    viewModel.document.observe(viewLifecycleOwner, Observer {
      if (it == com.patrickmota.core.domain.Document.EMPTY) {
