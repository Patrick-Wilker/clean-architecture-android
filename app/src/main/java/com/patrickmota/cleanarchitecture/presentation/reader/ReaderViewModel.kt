...
class ReaderViewModel(application: Application, interactors: Interactors) : MajesticViewModel
    ...
    companion object {
        ...
        fun createArguments(document: com.patrickmota.core.domain.Document) = bundleOf(
            DOCUMENT_ARG to document
        )
    }

    val document = MutableLiveData<com.patrickmota.core.domain.Document>()
    ...
    fun openBookmark(bookmark: com.patrickmota.core.domain.Bookmark) {
