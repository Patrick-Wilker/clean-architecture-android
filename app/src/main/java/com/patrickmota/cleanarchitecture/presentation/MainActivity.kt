...
import com.patrickmota.cleanarchitecture.presentation.reader.ReaderFragment
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener,
  ...
  override fun onNavigationItemSelected(item: MenuItem): Boolean {
    ...
    when (item.itemId) {
      ...
      R.id.nav_reader -> openDocument(
          com.patrickmota.core.domain.Document.EMPTY)
    }
    val drawerLayout: DrawerLayout = findViewById(
        R.id.drawer_layout)
    drawerLayout.closeDrawer(GravityCompat.START)
  ...
  override fun openDocument(document: com.patrickmota.core.domain.Document) {
